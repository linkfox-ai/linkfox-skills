"""Shared helpers for linkfox-shopee-store-top-picks (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "top-picks script") -> None:
...
SLUG = "linkfox-shopee-store-top-picks"
