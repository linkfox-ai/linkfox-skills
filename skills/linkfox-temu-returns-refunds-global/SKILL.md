...
> This skill exposes multiple entry scripts: `check_linkfox_token.py`, `get_temu_access_token.py`, `global_returns_refunds_aftersales_aftersales_list_get.py`, `global_returns_refunds_aftersales_carrier_get.py`, `global_returns_refunds_aftersales_parentaftersales_detail_get.py`, `global_returns_refunds_aftersales_parentaftersales_list_get.py`, `global_returns_refunds_aftersales_parentreturnorder_get.py`, `global_returns_refunds_aftersales_returnaddress_get.py`, `global_returns_refunds_aftersales_returnlabel_prepare_get.py`, `global_returns_refunds_aftersales_signature_get.py`, `global_returns_refunds_aftersales_upload_returnlabel.py`, `list_temu_access_tokens.py`, `save_temu_access_token.py`, `temu_file_download.py`, `temu_global_file_download.py`, `temu_global_proxy.py`, `temu_proxy.py`, `temu_token_guide.py`. Pass `--script scripts/<name>.py` to choose the one you need.
