#!/usr/bin/env python3
"""
Shopee Store — get_product_recommended_roi_target (v2.ads.get_product_recommended_roi_target)
...
def main() -> None:
    ...
    emit_result(run_ads_api("get_product_recommended_roi_target", params, "get_product_recommended_roi_target.py"), inline)
