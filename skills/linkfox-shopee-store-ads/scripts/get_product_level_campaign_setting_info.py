#!/usr/bin/env python3
"""
Shopee Store — get_product_level_campaign_setting_info (v2.ads.get_product_level_campaign_setting_info)
...
def main() -> None:
    ...
    emit_result(run_ads_api("get_product_level_campaign_setting_info", params, "get_product_level_campaign_setting_info.py"), inline)
