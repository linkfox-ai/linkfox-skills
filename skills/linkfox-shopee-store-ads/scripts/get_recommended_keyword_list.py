#!/usr/bin/env python3
"""
Shopee Store — get_recommended_keyword_list (v2.ads.get_recommended_keyword_list)
...
def main() -> None:
    ...
    emit_result(run_ads_api("get_recommended_keyword_list", params, "get_recommended_keyword_list.py"), inline)
