"""Shared helpers for linkfox-shopee-store-shop-flash-sale (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "shop-flash-sale script") -> None:
...
def get_api_key() -> str:
    ...
    if not key:
        print(
            ...
            "  (or LINKFOXAGENT_API_KEY=<your-key>)",
            file=sys.stderr,
        )
        sys.exit(1)
    return key
...
SLUG = "linkfox-shopee-store-shop-flash-sale"
