#!/usr/bin/env python3
"""
Seerfar Ozon Keyword Mining - LinkFox Skill
调用 /seerfar/ozon/keywordMining 接口。

Usage:
  python seerfar_ozon_keyword_mining.py '<JSON parameters>'           # 自动：小结果全量；大结果写文件+摘要
  python seerfar_ozon_keyword_mining.py '<JSON parameters>' --inline  # 强制全量打印到 stdout
...
API_PATH = "/seerfar/ozon/keywordMining"
SLUG = "linkfox-seerfar-ozon-keyword-mining"
