"""Shared helpers for linkfox-shopee-store-media-space (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "media-space script") -> None:
...
SLUG = "linkfox-shopee-store-media-space"
