#!/usr/bin/env python3
"""
SP Campaign Negative Targets Update - linkfox-amazon-ads-manager
===============================================================

PUT sp/campaignNegativeTargets (Amazon Ads).

Usage:
  python update_campaign_negative_targets.py '<JSON params>'

Required:
  profileId (number), region (NA/EU/FE), payload (Amazon-native body)

payload structure:
  {"campaignNegativeTargetingClauses":[{"targetId":123,...}]}
"""
