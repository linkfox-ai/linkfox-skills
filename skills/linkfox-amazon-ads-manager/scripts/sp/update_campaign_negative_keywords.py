#!/usr/bin/env python3
"""
SP Campaign Negative Keywords Update - linkfox-amazon-ads-manager
================================================================

PUT sp/campaignNegativeKeywords (Amazon Ads).

Usage:
  python update_campaign_negative_keywords.py '<JSON params>'

Required:
  profileId (number), region (NA/EU/FE), payload (Amazon-native body)

payload structure:
  {"campaignNegativeKeywords":[{"keywordId":123,...}]}
"""
...
ENTITY_PATH = "sp/campaignNegativeKeywords"
