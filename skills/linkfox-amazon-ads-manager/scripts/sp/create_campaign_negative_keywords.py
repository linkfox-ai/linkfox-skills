#!/usr/bin/env python3
"""
SP Campaign Negative Keywords Create - linkfox-amazon-ads-manager
================================================================

POST sp/campaignNegativeKeywords (Amazon Ads).

Usage:
  python create_campaign_negative_keywords.py '<JSON params>'
