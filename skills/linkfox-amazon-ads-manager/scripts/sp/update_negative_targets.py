#!/usr/bin/env python3
"""
SP Negative Targets Update - linkfox-amazon-ads-manager
======================================================

PUT sp/negativeTargets (Amazon Ads).

Usage:
  python update_negative_targets.py '<JSON params>'

Required:
  profileId (number), region (NA/EU/FE), payload (Amazon-native body)

payload structure:
  {"negativeTargetingClauses":[{"targetId":123,...}]}
"""
