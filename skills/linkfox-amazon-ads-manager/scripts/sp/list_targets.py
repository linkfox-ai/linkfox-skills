#!/usr/bin/env python3
"""
SP Targeting Clauses List - linkfox-amazon-ads-manager
=====================================================

POST sp/targets/list (Amazon Ads v3). 返回 SP 定向子句（auto / manual product-targeting）。
...
Optional filters:
  ...
  expressionTypeFilter     {"include": ["AUTO", "MANUAL"]}
...
def main() -> None:
    ...
    print(
        f"\n✓ Fetched {len(items)} targeting clauses across {output['pagesFetched']} page(s)"
