#!/usr/bin/env python3
"""
SP Negative Keywords Update - linkfox-amazon-ads-manager
=======================================================

PUT sp/negativeKeywords (Amazon Ads).

Usage:
  python update_negative_keywords.py '<JSON params>'

Required:
  profileId (number), region (NA/EU/FE), payload (Amazon-native body)

payload structure:
  {"negativeKeywords":[{"keywordId":123,...}]}
"""
...
ENTITY_PATH = "sp/negativeKeywords"
