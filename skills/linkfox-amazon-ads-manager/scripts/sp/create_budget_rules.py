#!/usr/bin/env python3
"""
SP Budget Rules Create - linkfox-amazon-ads-manager
==================================================

POST sp/budgetRules (Amazon Ads).
...
payload structure:
  {"budgetRules":[{"name":"...","ruleType":"SCHEDULE","duration":{...},"budgetIncreaseBy":{...}}]}
"""
