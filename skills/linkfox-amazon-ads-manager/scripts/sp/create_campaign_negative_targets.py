#!/usr/bin/env python3
"""
SP Campaign Negative Targets Create - linkfox-amazon-ads-manager
===============================================================

POST sp/campaignNegativeTargets (Amazon Ads).

Usage:
  python create_campaign_negative_targets.py '<JSON params>'
