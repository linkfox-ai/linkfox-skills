#!/usr/bin/env python3
"""
SP Budget Rules Association Create - linkfox-amazon-ads-manager
==============================================================

POST sp/budgetRulesAssociation (Amazon Ads).

Usage:
  python create_budget_rules_association.py '<JSON params>'

Required:
  profileId (number), region (NA/EU/FE), payload (Amazon-native body)

payload structure:
  {"budgetRulesAssociations":[{"ruleId":"...","campaignIds":[...]}]}
"""
...
ENTITY_PATH = "sp/budgetRulesAssociation"
