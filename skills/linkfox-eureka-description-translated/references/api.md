# Eureka 获取说明书翻译 API 参考

## 调用规范

- **请求地址**：`https://tool-gateway.linkfox.com/tool-eureka/descriptionDataTranslated`
...
```bash
curl -X POST https://tool-gateway.linkfox.com/tool-eureka/descriptionDataTranslated \
...
```json
{
  "skillName": "linkfox-eureka-description-translated",
  "sentiment": "POSITIVE",
  "category": "OTHER",
