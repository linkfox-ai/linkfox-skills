...
- **API 端点**：`POST /tool-eureka/descriptionDataTranslated`（完整参数/响应/错误码见 `references/api.md`）
- **Python 脚本**：`python scripts/eureka_description_translated.py '<JSON 参数>' [--inline]`
