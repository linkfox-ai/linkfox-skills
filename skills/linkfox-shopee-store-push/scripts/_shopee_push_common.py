"""Shared helpers for linkfox-shopee-store-push (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "push script") -> None:
...
SLUG = "linkfox-shopee-store-push"
