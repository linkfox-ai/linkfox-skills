"""Shared helpers for linkfox-shopee-store-account-health (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "account-health script") -> None:
...
SLUG = "linkfox-shopee-store-account-health"
