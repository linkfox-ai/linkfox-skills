#!/usr/bin/env python3
"""
Shopee Store — terminate_targeted_campaign (v2.ams.terminate_targeted_campaign)
...
def main() -> None:
    ...
    emit_result(run_ams_api("terminate_targeted_campaign", params, "terminate_targeted_campaign.py"), inline)
