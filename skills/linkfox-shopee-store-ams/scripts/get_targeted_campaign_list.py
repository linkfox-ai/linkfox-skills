#!/usr/bin/env python3
"""
Shopee Store — get_targeted_campaign_list (v2.ams.get_targeted_campaign_list)
...
def main() -> None:
    ...
    emit_result(run_ams_api("get_targeted_campaign_list", params, "get_targeted_campaign_list.py"), inline)
