#!/usr/bin/env python3
"""
Shopee Store — get_affiliate_performance (v2.ams.get_affiliate_performance)
...
def main() -> None:
    ...
    emit_result(run_ams_api("get_affiliate_performance", params, "get_affiliate_performance.py"), inline)
