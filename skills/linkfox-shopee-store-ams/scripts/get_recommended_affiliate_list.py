#!/usr/bin/env python3
"""
Shopee Store — get_recommended_affiliate_list (v2.ams.get_recommended_affiliate_list)
...
def main() -> None:
    ...
    emit_result(run_ams_api("get_recommended_affiliate_list", params, "get_recommended_affiliate_list.py"), inline)
