#!/usr/bin/env python3
"""
Shopee Store — edit_all_products_open_campaign_setting (v2.ams.edit_all_products_open_campaign_setting)
...
def main() -> None:
    ...
    emit_result(run_ams_api("edit_all_products_open_campaign_setting", params, "edit_all_products_open_campaign_setting.py"), inline)
