#!/usr/bin/env python3
"""
Shopee Store — get_open_campaign_not_added_product (v2.ams.get_open_campaign_not_added_product)
...
def main() -> None:
    ...
    emit_result(run_ams_api("get_open_campaign_not_added_product", params, "get_open_campaign_not_added_product.py"), inline)
