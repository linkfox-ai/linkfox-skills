"""Shared helpers for linkfox-shopee-store-ams (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "ams script") -> None:
