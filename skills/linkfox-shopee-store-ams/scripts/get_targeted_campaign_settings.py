#!/usr/bin/env python3
"""
Shopee Store — get_targeted_campaign_settings (v2.ams.get_targeted_campaign_settings)
...
def main() -> None:
    ...
    emit_result(run_ams_api("get_targeted_campaign_settings", params, "get_targeted_campaign_settings.py"), inline)
