#!/usr/bin/env python3
"""
Shopee Store — batch_add_products_to_open_campaign (v2.ams.batch_add_products_to_open_campaign)
...
def main() -> None:
    ...
    emit_result(run_ams_api("batch_add_products_to_open_campaign", params, "batch_add_products_to_open_campaign.py"), inline)
