#!/usr/bin/env python3
"""
Shopee Store — update_add_on_deal_main_item (v2.add_on_deal.update_add_on_deal_main_item)
...
def main() -> None:
    ...
    emit_result(run_add_on_deal_api("update_add_on_deal_main_item", params, "update_add_on_deal_main_item.py"), inline)
