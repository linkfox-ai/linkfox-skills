"""Shared helpers for linkfox-shopee-store-add-on-deal (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "add-on-deal script") -> None:
...
SLUG = "linkfox-shopee-store-add-on-deal"
