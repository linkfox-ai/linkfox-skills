#!/usr/bin/env python3
"""
Shopee Store — delete_add_on_deal (v2.add_on_deal.delete_add_on_deal)
...
def main() -> None:
    ...
    emit_result(run_add_on_deal_api("delete_add_on_deal", params, "delete_add_on_deal.py"), inline)
