#!/usr/bin/env python3
"""
Shopee Store — generate_and_bind_first_mile_tracking_number (v2.first_mile.generate_and_bind_first_mile_tracking_number)
...
def main() -> None:
    ...
    emit_result(run_first_mile_api("generate_and_bind_first_mile_tracking_number", params, "generate_and_bind_first_mile_tracking_number.py"), inline)
