#!/usr/bin/env python3
"""
Shopee Store — unbind_first_mile_tracking_number (v2.first_mile.unbind_first_mile_tracking_number)
...
def main() -> None:
    ...
    emit_result(run_first_mile_api("unbind_first_mile_tracking_number", params, "unbind_first_mile_tracking_number.py"), inline)
