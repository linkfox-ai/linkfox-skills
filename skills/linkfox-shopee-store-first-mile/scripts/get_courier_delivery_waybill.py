#!/usr/bin/env python3
"""
Shopee Store — get_courier_delivery_waybill (v2.first_mile.get_courier_delivery_waybill)
...
def main() -> None:
    ...
    emit_result(run_first_mile_api("get_courier_delivery_waybill", params, "get_courier_delivery_waybill.py"), inline)
