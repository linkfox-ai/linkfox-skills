"""Shared helpers for linkfox-shopee-store-first-mile (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "first-mile script") -> None:
...
SLUG = "linkfox-shopee-store-first-mile"
