"""Shared helpers for linkfox-shopee-store-discount (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "discount script") -> None:
...
SLUG = "linkfox-shopee-store-discount"
