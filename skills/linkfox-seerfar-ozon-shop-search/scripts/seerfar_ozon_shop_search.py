#!/usr/bin/env python3
"""
Seerfar Ozon Shop Search - LinkFox Skill
调用 /seerfar/ozon/shopSearch 接口。

Usage:
  python seerfar_ozon_shop_search.py '<JSON parameters>'           # 自动：小结果全量；大结果写文件+摘要
  python seerfar_ozon_shop_search.py '<JSON parameters>' --inline  # 强制全量打印到 stdout
...
API_PATH = "/seerfar/ozon/shopSearch"
