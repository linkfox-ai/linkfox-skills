"""Shared helpers for linkfox-shopee-store-payment (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "payment script") -> None:
...
SLUG = "linkfox-shopee-store-payment"
