#!/usr/bin/env python3
"""
Shopee Store — get_escrow_detail_batch (v2.payment.get_escrow_detail_batch)
...
def main() -> None:
    ...
    emit_result(run_payment_api("get_escrow_detail_batch", params, "get_escrow_detail_batch.py"), inline)
