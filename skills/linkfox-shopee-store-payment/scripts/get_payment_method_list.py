#!/usr/bin/env python3
"""
Shopee Store — get_payment_method_list (v2.payment.get_payment_method_list)
...
def main() -> None:
    ...
    emit_result(run_payment_api("get_payment_method_list", params, "get_payment_method_list.py"), inline)
