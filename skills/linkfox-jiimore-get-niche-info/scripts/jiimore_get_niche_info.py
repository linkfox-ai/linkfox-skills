...
调用 /jiimore/getNicheInfo 接口。

Usage:
  python jiimore_get_niche_info.py '<JSON parameters>'           # 自动：小结果全量；大结果写文件+摘要
  python jiimore_get_niche_info.py '<JSON parameters>' --inline  # 强制全量打印到 stdout
...
SLUG = "linkfox-jiimore-get-niche-info"
