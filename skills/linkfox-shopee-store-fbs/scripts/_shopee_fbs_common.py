"""Shared helpers for linkfox-shopee-store-fbs (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "fbs script") -> None:
