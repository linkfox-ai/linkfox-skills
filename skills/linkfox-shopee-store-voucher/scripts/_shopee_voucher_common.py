"""Shared helpers for linkfox-shopee-store-voucher (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "voucher script") -> None:
...
SLUG = "linkfox-shopee-store-voucher"
