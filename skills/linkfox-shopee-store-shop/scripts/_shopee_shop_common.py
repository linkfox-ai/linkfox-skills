"""Shared helpers for linkfox-shopee-store-shop (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "shop script") -> None:
...
SLUG = "linkfox-shopee-store-shop"
