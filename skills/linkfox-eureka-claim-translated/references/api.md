# Eureka 获取权利要求翻译 API 参考

## 调用规范

- **请求地址**：`https://tool-gateway.linkfox.com/tool-eureka/claimDataTranslated`
...
```bash
curl -X POST https://tool-gateway.linkfox.com/tool-eureka/claimDataTranslated \
...
```json
{
  "skillName": "linkfox-eureka-claim-translated",
  "sentiment": "POSITIVE",
  "category": "OTHER",
