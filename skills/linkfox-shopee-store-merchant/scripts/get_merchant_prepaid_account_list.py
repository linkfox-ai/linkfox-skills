#!/usr/bin/env python3
"""
Shopee Store — get_merchant_prepaid_account_list (v2.merchant.get_merchant_prepaid_account_list)
...
def main() -> None:
    ...
    emit_result(run_merchant_api("get_merchant_prepaid_account_list", params, "get_merchant_prepaid_account_list.py"), inline)
