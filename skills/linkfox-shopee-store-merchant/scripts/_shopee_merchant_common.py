"""Shared helpers for linkfox-shopee-store-merchant (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "merchant script") -> None:
...
SLUG = "linkfox-shopee-store-merchant"
