# `vendorTrafficReport.json` — 报告格式说明
...
- **Raw**：[vendorTrafficReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorTrafficReport.json)
