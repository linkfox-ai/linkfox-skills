# `vendorRealTimeTrafficReport.json` — 报告格式说明
...
- **Raw**：[vendorRealTimeTrafficReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorRealTimeTrafficReport.json)
