# `vendorForecastingReport.json` — 报告格式说明
...
- **Raw**：[vendorForecastingReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorForecastingReport.json)
