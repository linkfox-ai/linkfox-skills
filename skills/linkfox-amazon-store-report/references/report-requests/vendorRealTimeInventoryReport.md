# `vendorRealTimeInventoryReport.json` — 报告格式说明
...
- **Raw**：[vendorRealTimeInventoryReport.json](https://raw.githubusercontent.com/amzn/selling-partner-api-models/main/schemas/reports/vendorRealTimeInventoryReport.json)
