#!/usr/bin/env python3
"""
Shopee Store — get_video_detail_product_performance (v2.video.get_video_detail_product_performance)
...
def main() -> None:
    ...
    emit_result(run_video_api("get_video_detail_product_performance", params, "get_video_detail_product_performance.py"), inline)
