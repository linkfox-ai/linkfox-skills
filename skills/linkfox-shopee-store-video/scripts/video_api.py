#!/usr/bin/env python3
"""
Shopee Store — generic Video API caller
========================================

Usage:
  python video_api.py '{"api": "get_cover_list", "shopId": "67890"}'

Official docs: https://open.shopee.com/documents/v2/v2.video.<api>?module=129&type=1
"""
...
def main() -> None:
    ...
    emit_result(run_video_api(str(params["api"]), params, "video_api.py"), inline)
