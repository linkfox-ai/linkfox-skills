#!/usr/bin/env python3
"""
多参考图生视频 - LinkFox Skill (异步模式)
调用 aigc/multiImageVideoGenAsync 创建任务，然后轮询 aigc/taskQuery 获取结果。
"""
...
CREATE_PATH = "/aigc/multiImageVideoGenAsync"
QUERY_PATH = "/aigc/taskQuery"
SLUG = "linkfox-aigc-videogen-multi"
POLL_INTERVAL = 10
MAX_POLL_TIME = 1200
INITIAL_DELAY = 120
...
def main():
    ...
    if not argv:
        print("Usage: aigc_videogen_multi.py '<JSON>'", file=sys.stderr)
        sys.exit(1)
