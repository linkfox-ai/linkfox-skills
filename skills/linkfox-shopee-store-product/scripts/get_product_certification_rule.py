#!/usr/bin/env python3
"""
Shopee Store — get_product_certification_rule (v2.product.get_product_certification_rule)
...
def main() -> None:
    ...
    emit_result(run_product_api("get_product_certification_rule", params, "get_product_certification_rule.py"), inline)
