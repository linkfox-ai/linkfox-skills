#!/usr/bin/env python3
"""
Shopee Store — get_size_chart_detail (v2.product.get_size_chart_detail)
...
def main() -> None:
    ...
    emit_result(run_product_api("get_size_chart_detail", params, "get_size_chart_detail.py"), inline)
