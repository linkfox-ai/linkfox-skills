"""Shared helpers for linkfox-shopee-store-product (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "product script") -> None:
...
SLUG = "linkfox-shopee-store-product"
