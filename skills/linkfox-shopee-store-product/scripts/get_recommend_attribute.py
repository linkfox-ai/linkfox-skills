#!/usr/bin/env python3
"""
Shopee Store — get_recommend_attribute (v2.product.get_recommend_attribute)
...
def main() -> None:
    ...
    emit_result(run_product_api("get_recommend_attribute", params, "get_recommend_attribute.py"), inline)
