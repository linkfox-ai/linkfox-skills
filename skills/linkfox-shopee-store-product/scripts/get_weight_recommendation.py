#!/usr/bin/env python3
"""
Shopee Store — get_weight_recommendation (v2.product.get_weight_recommendation)
...
def main() -> None:
    ...
    emit_result(run_product_api("get_weight_recommendation", params, "get_weight_recommendation.py"), inline)
