"""Shared helpers for linkfox-shopee-store-media (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "media script") -> None:
...
SLUG = "linkfox-shopee-store-media"
