"""Shared helpers for linkfox-shopee-store-follow-prize (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "follow-prize script") -> None:
...
SLUG = "linkfox-shopee-store-follow-prize"
