#!/usr/bin/env python3
"""
Shopee Store — update_bundle_deal_item (v2.bundle_deal.update_bundle_deal_item)
...
def main() -> None:
    ...
    emit_result(run_bundle_deal_api("update_bundle_deal_item", params, "update_bundle_deal_item.py"), inline)
