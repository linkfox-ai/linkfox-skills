"""Shared helpers for linkfox-shopee-store-bundle-deal (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "bundle-deal script") -> None:
...
SLUG = "linkfox-shopee-store-bundle-deal"
