#!/usr/bin/env python3
"""
Shopee Store — delete_bundle_deal_item (v2.bundle_deal.delete_bundle_deal_item)
...
def main() -> None:
    ...
    emit_result(run_bundle_deal_api("delete_bundle_deal_item", params, "delete_bundle_deal_item.py"), inline)
