"""Shared helpers for linkfox-shopee-store-sbs (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "sbs script") -> None:
...
def get_api_key() -> str:
    ...
    if not key:
        print(
            ...
            "  (or legacy LINKFOXAGENT_API_KEY)",
            file=sys.stderr,
        )
        sys.exit(1)
    return key
