#!/usr/bin/env python3
"""
Shopee Store — get_global_item_id (v2.global_product.get_global_item_id)
...
def main() -> None:
    ...
    emit_result(run_global_product_api("get_global_item_id", params, "get_global_item_id.py"), inline)
