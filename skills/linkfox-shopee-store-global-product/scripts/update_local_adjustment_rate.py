#!/usr/bin/env python3
"""
Shopee Store — update_local_adjustment_rate (v2.global_product.update_local_adjustment_rate)
...
def main() -> None:
    ...
    emit_result(run_global_product_api("update_local_adjustment_rate", params, "update_local_adjustment_rate.py"), inline)
