#!/usr/bin/env python3
"""
Shopee Store — get_global_model_list (v2.global_product.get_global_model_list)
...
def main() -> None:
    ...
    emit_result(run_global_product_api("get_global_model_list", params, "get_global_model_list.py"), inline)
