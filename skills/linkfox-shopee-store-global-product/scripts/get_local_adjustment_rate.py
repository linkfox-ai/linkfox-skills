#!/usr/bin/env python3
"""
Shopee Store — get_local_adjustment_rate (v2.global_product.get_local_adjustment_rate)
...
def main() -> None:
    ...
    emit_result(run_global_product_api("get_local_adjustment_rate", params, "get_local_adjustment_rate.py"), inline)
