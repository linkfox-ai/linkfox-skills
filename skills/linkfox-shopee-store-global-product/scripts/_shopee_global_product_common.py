"""Shared helpers for linkfox-shopee-store-global-product (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "global-product script") -> None:
...
SLUG = "linkfox-shopee-store-global-product"
