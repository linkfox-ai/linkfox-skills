#!/usr/bin/env python3
"""
Shopee Store — support_size_chart (v2.global_product.support_size_chart)
...
def main() -> None:
    ...
    emit_result(run_global_product_api("support_size_chart", params, "support_size_chart.py"), inline)
