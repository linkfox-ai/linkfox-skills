#!/usr/bin/env python3
"""
Shopee Store — delete_global_item (v2.global_product.delete_global_item)
...
def main() -> None:
    ...
    emit_result(run_global_product_api("delete_global_item", params, "delete_global_item.py"), inline)
