"""Shared helpers for linkfox-shopee-store-livestream (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "livestream script") -> None:
...
SLUG = "linkfox-shopee-store-livestream"
