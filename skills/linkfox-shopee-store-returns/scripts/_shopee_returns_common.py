"""Shared helpers for linkfox-shopee-store-returns (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "returns script") -> None:
...
SLUG = "linkfox-shopee-store-returns"
