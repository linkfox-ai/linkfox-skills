#!/usr/bin/env python3
"""
Shopee Store — upload_shipping_proof (v2.returns.upload_shipping_proof)
...
def main() -> None:
    ...
    emit_result(run_returns_api("upload_shipping_proof", params, "upload_shipping_proof.py"), inline)
