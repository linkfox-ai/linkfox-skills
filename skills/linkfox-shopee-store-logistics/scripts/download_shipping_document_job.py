#!/usr/bin/env python3
"""
Shopee Store — download_shipping_document_job (v2.logistics.download_shipping_document_job)
...
def main() -> None:
    ...
    emit_result(run_logistics_api("download_shipping_document_job", params, "download_shipping_document_job.py"), inline)
