"""Shared helpers for linkfox-shopee-store-logistics (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "logistics script") -> None:
...
SLUG = "linkfox-shopee-store-logistics"
