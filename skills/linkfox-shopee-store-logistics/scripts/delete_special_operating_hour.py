#!/usr/bin/env python3
"""
Shopee Store — delete_special_operating_hour (v2.logistics.delete_special_operating_hour)
...
def main() -> None:
    ...
    emit_result(run_logistics_api("delete_special_operating_hour", params, "delete_special_operating_hour.py"), inline)
