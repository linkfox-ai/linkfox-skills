#!/usr/bin/env python3
"""
Shopee Store — download_shipping_document (v2.logistics.download_shipping_document)
...
def main() -> None:
    ...
    emit_result(run_logistics_api("download_shipping_document", params, "download_shipping_document.py"), inline)
