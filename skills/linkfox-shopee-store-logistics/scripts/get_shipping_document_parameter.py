#!/usr/bin/env python3
"""
Shopee Store — get_shipping_document_parameter (v2.logistics.get_shipping_document_parameter)
...
def main() -> None:
    ...
    emit_result(run_logistics_api("get_shipping_document_parameter", params, "get_shipping_document_parameter.py"), inline)
