"""Shared helpers for linkfox-shopee-store-public (storeTokens + developerProxy)."""
...
def ensure_auth_skill_available(caller: str = "public script") -> None:
...
SLUG = "linkfox-shopee-store-public"
