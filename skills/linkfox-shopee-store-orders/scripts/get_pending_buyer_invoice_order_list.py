#!/usr/bin/env python3
"""
Shopee Store — get_pending_buyer_invoice_order_list (v2.order.get_pending_buyer_invoice_order_list)
...
def main() -> None:
    ...
    emit_result(run_order_api("get_pending_buyer_invoice_order_list", params, "get_pending_buyer_invoice_order_list.py"), inline)
