#!/usr/bin/env python3
"""
Shopee Store — get_warehouse_filter_config (v2.order.get_warehouse_filter_config)
...
def main() -> None:
    ...
    emit_result(run_order_api("get_warehouse_filter_config", params, "get_warehouse_filter_config.py"), inline)
