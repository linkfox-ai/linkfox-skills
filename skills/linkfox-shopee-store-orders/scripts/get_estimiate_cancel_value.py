#!/usr/bin/env python3
"""
Shopee Store — get_estimiate_cancel_value (v2.order.get_estimiate_cancel_value)
...
def main() -> None:
    ...
    emit_result(run_order_api("get_estimiate_cancel_value", params, "get_estimiate_cancel_value.py"), inline)
